...
export const THEMES: Record<PuertoRicoThemeKey, ThemeText> = {
  ...
  puerto_rifto: themed({
    ...
    roleDescriptions: {
      settler: "Everyone carves a lane from living stone.",
    ...
    buildings: {
      small_indigo_plant: "Double Up",
      small_sugar_mill: "Javelin Toss",
      indigo_plant: "Trueshot Barrage",
      sugar_mill: "Rampant Growth",
      tobacco_storage: "Cataclysm",
      coffee_roaster: "Pick a Card",
      small_market: "Loaded Dice",
      hacienda: "Destiny",
      construction_hut: "Seismic Shard",
      small_warehouse: "Spell Shield",
      hospice: "Astral Infusion",
      office: "Stacked Deck",
      large_market: "Parrrley",
      large_warehouse: "Unbreakable",
      factory: "H-28 G Evolution Turret",
      university: "UPGRADE!!!",
      harbor: "Make It Rain",
      wharf: "Cannon Barrage",

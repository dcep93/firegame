...
export const THEMES: Record<PuertoRicoThemeKey, ThemeText> = {
  ...
  gymbro_rico: themed({
    ...
    roleDescriptions: {
      ...
      trader: "Everyone may sell one supplement.",
    ...
    roleRewards: {
      ...
      builder: "Chooser pays 1 less.",
      craftsman: "Chooser may take 1 extra gain.",
      trader: "Chooser earns +1 protein.",
      captain: "Chooser earns +1 VP once.",
      prospector_1: "Chooser takes 1 protein.",
      prospector_2: "Chooser takes 1 protein.",
    },
    goods: { corn: "Reps", indigo: "Chalk", sugar: "Whey", tobacco: "Creatine", coffee: "PRs" },
    plantations: {
      corn: "Reps",
      indigo: "Chalk",
      sugar: "Whey",
    ...
    buildings: {
      small_indigo_plant: "Small Chalk Bowl",
      small_sugar_mill: "Small Whey Tub",
      indigo_plant: "Chalk Bowl",
      sugar_mill: "Whey Tub",
      tobacco_storage: "Creatine Shelf",
      coffee_roaster: "PR Platform",
      small_market: "Small Shake Bar",
      hacienda: "Free Trial",
      construction_hut: "Rack Dealer",
      small_warehouse: "Small Locker",
      hospice: "Recovery Room",
      office: "Bro Science Desk",
      large_market: "Large Shake Bar",
      large_warehouse: "Large Locker",
    ...
    buildingDescriptions: buildingCopy({
      ...
      tobacco: "creatine",
      coffee: "PRs",
      indigoSource: "chalk workouts",
      sugarSource: "whey workouts",
      tobaccoSource: "creatine workouts",
      coffeeSource: "PR workouts",
      money: "protein",
      settler: "bulk",
      quarry: "squat rack",
      goods: "gain",
      ...
      harbor: "flex",
      wharf: "private flex",
      smallProduction: "small gain station",
      largeProduction: "large",
      island: "workout",
      shipped: "flexed",
      civic: "gym",
    ...
    labels: {
      ...
      tradingHouse: "Shake counter",
      colonistShip: "Gym bro van",
      goodsSupply: "Supplement shelf",
      empty: "Open",
      open: "Open",
      goods: "Gains",
      noGoods: "No gains",
    ...
    actions: {
      ...
      storagePrompt: "Discard until remaining gains fit your locker.",
      take: "Take",
      sell: "Sell",
      ship: "Flex",
      onShip: "in queue",

...
function buildingCopy(words: {
  ...
  return {
    ...
    office: `May sell ${words.goods} already on the market.`,
    ...
    harbor: `+1 VP each time you send ${words.goods} via ${words.harbor}.`,
    wharf: `Once per ${words.captain}, send all ${words.goods} of one kind by ${words.wharf}.`,
    ...
    city_hall: `End: +1 VP for each ${words.civic} ${words.building}, including itself.`,
  };
}
...
export const THEMES: Record<PuertoRicoThemeKey, ThemeText> = {
  ...
  corpo_rico: themed({
    ...
    roleDescriptions: {
      settler: "Everyone expands the branch network.",
      mayor: "Everyone staffs the org chart.",
      builder: "Everyone may launch one office.",
      craftsman: "Everyone fills the pharma pipeline.",
      trader: "Everyone may close one sale.",
      captain: "Everyone deploys pharma for VP.",
      prospector_1: "No shared function.",
      prospector_2: "No shared function.",
    },
    roleRewards: {
      settler: "Chooser may take happy hour.",
    ...
    buildings: {
      ...
      construction_hut: "Happy Hour Desk",
    ...
    buildingDescriptions: {
      ...
      construction_hut: "May take happy hour instead of a branch.",
      small_warehouse: "Stores all units of 1 pharma kind.",
      hospice: "Adds staff to a new branch or happy hour.",
      ...
      wharf: "Once per deploy, deploy all of one pharma kind.",
      ...
      customs_house: "Closeout: +1 VP for every 4 deployed VP.",
    ...
    messages: {
      ...
      settledQuarry: (playerName) => `${playerName} scheduled happy hour`,
      passed: (playerName) => `${playerName} passed`,
  ...
  porko_rico: themed({
    ...
    roleDescriptions: {
      settler: "Everyone claims a pasture.",
      mayor: "Everyone fields farmhands.",
      builder: "Everyone may raise one barn.",
      craftsman: "Everyone mixes feed.",
    ...
    buildings: {
      ...
      harbor: "Loading Pen",
      wharf: "Private Cart",
      guild_hall: "Boar Court",
      residence: "Hog Mansion",
      fortress: "Mud Guard",
      customs_house: "Slop Auditor",
      city_hall: "County Trough",
    },
  ...
  puerto_burrito: themed({
    ...
    roleDescriptions: {
      settler: "Everyone claims a prep tray.",
      mayor: "Everyone staffs crew.",
      builder: "Everyone may install one truck station.",
      craftsman: "Everyone preps fillings.",
      trader: "Everyone may sell one filling.",
      captain: "Everyone runs orders for VP.",
      prospector_1: "No shared station.",
      prospector_2: "No shared station.",
    },
    roleRewards: {
      settler: "Chooser may take a cholo.",
  ...
  puerto_disco: themed({
    ...
    roleDescriptions: {
      settler: "Everyone lights a dance floor.",
      mayor: "Everyone fills the floor with dancers.",
      builder: "Everyone may open one club room.",
      craftsman: "Everyone tunes the band.",
      trader: "Everyone may sell one instrument at the bar.",
      captain: "Everyone plays the encore for VP.",
  ...
  puerto_weedo: themed({
    ...
    roleDescriptions: {
      settler: "Everyone plants a garden.",
      mayor: "Everyone staffs the grow crew.",
      builder: "Everyone may build one grow room.",
      craftsman: "Everyone harvests the crop.",
      trader: "Everyone may sell one product.",
      captain: "Everyone sends deliveries for VP.",
      prospector_1: "No shared shift.",
      prospector_2: "No shared shift.",
    },
    roleRewards: {
      settler: "Chooser may take munchies.",
      mayor: "Chooser takes 1 crew first.",
      builder: "Chooser pays 1 less.",
    ...
    messages: {
      ...
      settledQuarry: (playerName) => `${playerName} stocked munchies`,
      passed: (playerName) => `${playerName} passed`,
      recalledColonists: (playerName) => `${playerName} recalled crew`,
  ...
  dowdle_rico: themed({
    ...
    roleDescriptions: {
      settler: "Everyone recruits a play sheet.",
      mayor: "Everyone sets the depth chart.",
      builder: "Everyone may build one facility.",
      craftsman: "Everyone runs the offense.",
      trader: "Everyone may trade one stat.",
      captain: "Everyone drives stats into points.",
      prospector_1: "No shared play.",
      prospector_2: "No shared play.",
    },
    roleRewards: {
      settler: "Chooser may take a referee.",
    ...
    messages: {
      ...
      settledQuarry: (playerName) => `${playerName} hired a referee`,
  ...
  gymbro_rico: themed({
    ...
    roleDescriptions: {
      settler: "Everyone adds a workout to the split.",
      mayor: "Everyone spots gym bros.",
      builder: "Everyone may install one station.",
      craftsman: "Everyone trains muscle groups.",
    ...
    roleRewards: {
      settler: "Chooser may take steroids.",
    ...
    buildings: {
      ...
      hacienda: "Free Trial",
      construction_hut: "Steroid Dealer",
      small_warehouse: "Small Locker",
    ...
    messages: {
      ...
      settledQuarry: (playerName) => `${playerName} claimed steroids`,
  ...
  puerto_rifto: themed({
    ...
    roleDescriptions: {
      settler: "Everyone claims a lane across worked ground.",
      mayor: "Everyone rallies champions to the board.",
      builder: "Everyone may forge one item.",
      craftsman: "Everyone clears jungle camps for roles.",
      trader: "Everyone may cut one deal.",
      captain: "Everyone joins the Bilgewater fight for VP.",
      prospector_1: "No shared expedition.",
      prospector_2: "No shared bounty.",
    },
    roleRewards: {
      settler: "Chooser may take a Poro.",
      mayor: "Chooser rallies 1 champion first.",
      builder: "Chooser pays 1 less.",
      craftsman: "Chooser may take 1 extra role.",
      trader: "Chooser earns +1 gold when dealing.",
      captain: "Chooser earns +1 VP once.",
    ...
    buildings: {
      small_indigo_plant: "Small Piltovan Arsenal",
      small_sugar_mill: "Small Kumungu Camp",
      indigo_plant: "Piltovan Arsenal",
      sugar_mill: "Gardens of Zyr",
      tobacco_storage: "Immortal Bastion",
      coffee_roaster: "Sun Disc",
      small_market: "Small Sun Gate Stall",
      hacienda: "Oasis of the Dawn",
      construction_hut: "Hearth-Home Forge",
      small_warehouse: "Ecliptic Vaults",
      hospice: "Starchild's Yurt",
      office: "Glasc Industries",
      large_market: "Sun Gates Bazaar",
      large_warehouse: "Piltover Treasury",
      factory: "Zaun Chemworks",
      university: "College of Techmaturgy",
      harbor: "Bilgewater Bay",
      wharf: "Slaughter Docks",
    ...
    messages: {
      ...
      settledQuarry: (playerName) => `${playerName} took a Poro`,
  ...
  puerto_sicko: themed({
    ...
    roleDescriptions: {
      settler: "Everyone admits a ward.",
      mayor: "Everyone covers rounds with staff.",
    ...
    roleRewards: {
      settler: "Chooser may take a crystal.",
    ...
    buildings: {
      ...
      construction_hut: "Crystal Referral",
    ...
    messages: {
      ...
      settled: (playerName, plantationName) => `${playerName} opened ${plantationName}`,
      settledQuarry: (playerName) => `${playerName} charged a crystal`,
  ...
  puerto_yugioh: themed({
    ...
    roleDescriptions: {
      settler: "Everyone sets a zone.",
      mayor: "Everyone summons duelists.",
    ...
    roleRewards: {
      settler: "Chooser may take Friendship.",
    ...
    buildings: {
      ...
      construction_hut: "Friendship Finder",
    ...
    messages: {
      ...
      settledQuarry: (playerName) => `${playerName} equipped Friendship`,
  ...
  puerto_rato: themed({
    ...
    roleDescriptions: {
      settler: "Everyone claims a borough tile or spreads disease.",
      mayor: "Everyone musters rats.",
      builder: "Everyone may dig one room.",
      craftsman: "Everyone sorts the hoard.",
      trader: "Everyone may fence one hoard item.",
      captain: "Everyone raids the hoard for VP.",
      prospector_1: "No shared scheme.",
      prospector_2: "No shared scheme.",
    },
    roleRewards: {
      settler: "Chooser may spread disease.",
    ...
    buildings: {
      ...
      construction_hut: "Disease Vector",
    ...
    messages: {
      ...
      settled: (playerName, plantationName) => `${playerName} claimed ${plantationName}`,
      settledQuarry: (playerName) => `${playerName} spread a disease`,
  ...
  los_santos_rico: themed({
    ...
    phase: {
      ...
      mayor: "Crew-up",
      builder: "Front buy",
      craftsman_bonus: "Score bonus",
      trader: "Black market",
      captain: "Shootout",
      storage: "Evidence dump",
      game_over: "Final rap sheet",
    },
    roles: {
      settler: "Turf Vulture",
      mayor: "Shot Caller",
      builder: "Front Man",
      craftsman: "Arms Runner",
      trader: "Black-Market Fence",
      captain: "Getaway Killer",
      prospector_1: "Dirty Cop",
      prospector_2: "Dirty Cop",
    },
    roleDescriptions: {
      settler: "Everyone grabs turf.",
      mayor: "Everyone posts muscle.",
      builder: "Everyone may buy one front.",
      craftsman: "Everyone arms the next score.",
      trader: "Everyone may fence one score.",
      captain: "Everyone hits the score for VP.",
      prospector_1: "No shared crime.",
      prospector_2: "No shared crime.",
    },
    roleRewards: {
      settler: "Chooser may take a chop shop.",
    ...
    goods: { corn: "Ammo", indigo: "Heat", sugar: "Dirty Cash", tobacco: "Guns", coffee: "Supercars" },
    plantations: {
      corn: "Ammo",
      indigo: "Heat",
      sugar: "Dirty Cash",
    ...
    buildings: {
      small_indigo_plant: "Small Heat Sink",
      small_sugar_mill: "Small Cash Wash",
      indigo_plant: "Heat Sink",
      sugar_mill: "Cash Wash",
      tobacco_storage: "Gun Locker",
      coffee_roaster: "Supercar Cage",
      small_market: "Small Black Market",
      hacienda: "Snitch Tip",
      construction_hut: "Chop Permit",
      small_warehouse: "Small Stash House",
      hospice: "Back-Alley Doc",
      office: "Corrupt Lawyer",
      large_market: "Large Black Market",
      large_warehouse: "Large Stash House",
      factory: "Cartel Lab",
      university: "Felony School",
      harbor: "Smuggler Dock",
      wharf: "Solo Hit",
      guild_hall: "Cartel Table",
      residence: "Blood Penthouse",
      fortress: "Wanted Bunker",
      customs_house: "Bribe Office",
      city_hall: "Crooked City Hall",
    },
    buildingDescriptions: buildingCopy({
      indigo: "heat",
      sugar: "dirty cash",
      tobacco: "guns",
      coffee: "supercars",
      indigoSource: "heat blocks",
      sugarSource: "cash blocks",
      tobaccoSource: "gun blocks",
      ...
      harbor: "smuggle",
      wharf: "solo hit",
      smallProduction: "small crime front",
      largeProduction: "large",
      island: "block",
      shipped: "hit",
      civic: "city",
    ...
    labels: {
      ...
      plantations: "Blocks",
      quarries: "Chop shops",
      cargoShips: "Hit lanes",
      tradingHouse: "Fence meet",
      colonistShip: "Crew van",
      goodsSupply: "Loot supply",
      empty: "Open",
      open: "Open",
      goods: "Loot",
      noGoods: "No loot",
      ...
      buildings: "Fronts",
      quarry: "chop shop",
      quarriesPlural: "chop shops",
      finalScoring: "Final rap sheet",
      shipped: "hit",
      buildingScore: "fronts",
    },
    actions: {
      chooseRole: "Choose a crime.",
      choosingRole: (playerName) => `${playerName} is choosing a crime.`,
      haciendaTile: "Snitch block",
      mayorHelp: "Click muscle dots on your blocks and safehouse to staff the crew.",
      buildPrompt: "Buy from the front market below or pass.",
      storagePrompt: "Dump loot until the rest fits your safehouse stash.",
      take: "Take",
      sell: "Fence",
      ship: "Hit",
      onShip: "in lane",
    ...
    messages: {
      changedTheme: (themeName) => `changed the wanted poster to ${themeName}`,
      choseRole: (playerName, roleName) => `${playerName} called ${roleName}`,
      prospected: (playerName) => `${playerName} shook down a dirty cop`,
      usedHacienda: (playerName, goodName) => `${playerName} squeezed a snitch for ${goodName}`,
      settled: (playerName, plantationName) => `${playerName} seized ${plantationName}`,
      settledQuarry: (playerName) => `${playerName} opened a chop shop`,
      passed: (playerName) => `${playerName} ducked the heat`,
      recalledColonists: (playerName) => `${playerName} pulled the crew back`,
      placedColonist: (playerName) => `${playerName} posted muscle`,
      movedColonistToSanJuan: (playerName) => `${playerName} sent muscle to jail`,
      finishedColonists: (playerName) => `${playerName} loaded the crew`,
      built: (playerName, buildingName) => `${playerName} bought ${buildingName}`,
      tookExtraGood: (playerName, goodName) => `${playerName} grabbed extra ${goodName}`,
      skippedExtraGood: (playerName) => `${playerName} skipped the extra score`,
      producedGoods: () => "armed the scores",
      sold: (playerName, goodName) => `${playerName} fenced ${goodName}`,
      shipped: (playerName, amount, goodName) => `${playerName} hit ${amount} ${goodName}`,
      usedWharf: (playerName, amount, goodName) => `${playerName} ran a solo hit with ${amount} ${goodName}`,

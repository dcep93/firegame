...
export const THEMES: Record<PuertoRicoThemeKey, ThemeText> = {
  ...
  puerto_burrito: themed({
    ...
    goods: { corn: "Chicken", indigo: "Steak", sugar: "Pork", tobacco: "Chorizo", coffee: "Barbacoa" },
    plantations: {
      corn: "Chicken",
      indigo: "Steak",
      sugar: "Pork",
    ...
    buildingDescriptions: buildingCopy({
      ...
      tobacco: "chorizo",
      coffee: "barbacoa",
      indigoSource: "steak trays",
      sugarSource: "pork trays",
      tobaccoSource: "chorizo trays",
      coffeeSource: "barbacoa trays",
      money: "tips",
      settler: "prep",
      quarry: "commissary",
      goods: "filling",

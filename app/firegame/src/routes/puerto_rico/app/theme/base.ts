...
export const THEMES: Record<PuertoRicoThemeKey, ThemeText> = {
  ...
  puerto_rifto: themed({
    ...
    buildings: {
      ...
      office: "Stacked Deck",
      large_market: "Wild Cards",
      large_warehouse: "Unbreakable",
      factory: "H-28G Evolution Turret",
      university: "UPGRADE!!!",
      harbor: "Make It Rain",
      wharf: "Cannon Barrage",
      guild_hall: "Glorious Evolution",
      residence: "Emperor's Divide",
      fortress: "Cataclysm",
      customs_house: "Parrrley",
      city_hall: "Stand United",
    },
    buildingDescriptions: buildingCopy({
      indigo: "ADC",
      sugar: "jungle",

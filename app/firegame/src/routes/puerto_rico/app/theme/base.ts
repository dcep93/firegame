...
export const THEMES: Record<PuertoRicoThemeKey, ThemeText> = {
  ...
  gymbro_rico: themed({
    ...
    goods: { corn: "Chest", indigo: "Back", sugar: "Legs", tobacco: "Shoulders", coffee: "Arms" },
    plantations: {
      corn: "Chest",
      indigo: "Back",
      sugar: "Legs",
    ...
    buildings: {
      ...
      small_sugar_mill: "Small Leg Press",
      indigo_plant: "Back Machine",
      sugar_mill: "Leg Press",
      ...
      harbor: "Mirror Wall",
      wharf: "Private Flex",
      guild_hall: "Lifter Council",
      residence: "Meal Prep Cave",
      fortress: "No Curl Rack",
      customs_house: "Check-in Desk",
      city_hall: "Gym Office",
    },
    buildingDescriptions: buildingCopy({
      indigo: "back",
      sugar: "legs",
  ...
  puerto_rifto: themed({
    ...
    roleDescriptions: {
      ...
      craftsman: "Everyone farms objectives.",
      trader: "Everyone may trade one objective.",
    ...
    roleRewards: {
      ...
      builder: "Chooser pays 1 less.",
      craftsman: "Chooser may take 1 extra objective.",
      trader: "Chooser earns +1 gold.",
      captain: "Chooser earns +1 VP once.",
      prospector_1: "Chooser takes 1 gold.",
      prospector_2: "Chooser takes 1 gold.",
    },
    goods: { corn: "Minions", indigo: "Wards", sugar: "Plates", tobacco: "Drakes", coffee: "Barons" },
    plantations: {
      corn: "Minions",
      indigo: "Wards",
      sugar: "Plates",
    ...
    buildings: {
      small_indigo_plant: "Small Ward Totem",
      small_sugar_mill: "Small Plate Stack",
      indigo_plant: "Ward Totem",
      sugar_mill: "Plate Stack",
      tobacco_storage: "Drake Pit",
      coffee_roaster: "Baron Pit",
      ...
      harbor: "River Fight",
      wharf: "Teleport Play",
      guild_hall: "Team House",
      residence: "Nexus",
      fortress: "Inhibitor",
      customs_house: "Bounty Board",
      city_hall: "Victory Screen",
    },
    buildingDescriptions: buildingCopy({
      indigo: "wards",
      sugar: "plates",
      tobacco: "drakes",
      coffee: "barons",
      indigoSource: "ward lanes",
      sugarSource: "plate lanes",
      tobaccoSource: "drake lanes",
      coffeeSource: "baron lanes",
      money: "gold",
      settler: "laning",
      quarry: "blue buff",
      goods: "objective",
      ...
      harbor: "river fight",
      wharf: "teleport",
      smallProduction: "small objective item",
      largeProduction: "large",
      island: "lane",
      shipped: "scored",
      civic: "Rift",
    ...
    labels: {
      ...
      goodsSupply: "Objective supply",
      empty: "Open",
      open: "Open",
      goods: "Objectives",
      noGoods: "No objectives",
      island: "Lane",
      city: "Build",
      sanJuan: "Fountain",
      governor: "Shotcaller",
    ...
    actions: {
      ...
      storagePrompt: "Discard until remaining objectives fit your recall.",
      take: "Take",
      sell: "Trade",
      ship: "Fight",
      onShip: "in lane",
    ...
    messages: {
      ...
      producedGoods: () => "farmed objectives",
      sold: (playerName, goodName) => `${playerName} traded ${goodName}`,
      ...
      discarded: (playerName, goodName) => `${playerName} dropped ${goodName}`,
      stored: (playerName) => `${playerName} recalled objectives`,
      phaseFinished: (phaseName) => `${phaseName} finished`,
    },
  }),
  puerto_sicko: themed({
    ...
    roleDescriptions: {
      ...
      builder: "Everyone may open one room.",
      craftsman: "Everyone processes samples.",
      trader: "Everyone may bill one case.",
      captain: "Everyone discharges cases for VP.",
    ...
    roleRewards: {
      ...
      builder: "Chooser pays 1 less.",
      craftsman: "Chooser may take 1 extra sample.",
      trader: "Chooser earns +1 copay.",
      captain: "Chooser earns +1 VP once.",
      prospector_1: "Chooser takes 1 copay.",
      prospector_2: "Chooser takes 1 copay.",
    },
    goods: { corn: "Vitals", indigo: "Bandages", sugar: "X-rays", tobacco: "Samples", coffee: "Diagnoses" },
    plantations: {
      corn: "Vitals",
      indigo: "Bandages",
      sugar: "X-rays",
    ...
    buildings: {
      small_indigo_plant: "Small Bandage Cart",
      small_sugar_mill: "Small X-ray Room",
      indigo_plant: "Bandage Cart",
      sugar_mill: "X-ray Room",
      tobacco_storage: "Sample Lab",
      coffee_roaster: "Diagnosis Desk",
      ...
      wharf: "Ambulance Bay",
      guild_hall: "Medical Board",
      residence: "Patient Wing",
      fortress: "Security Desk",
      customs_house: "Claims Office",
      city_hall: "Hospital Admin",
    },
    buildingDescriptions: buildingCopy({
      indigo: "bandages",
      sugar: "X-rays",
      tobacco: "samples",
      coffee: "diagnoses",
      indigoSource: "bandage wards",
      sugarSource: "X-ray wards",
      tobaccoSource: "sample wards",
      coffeeSource: "diagnosis wards",
      money: "copays",
      settler: "admissions",
      quarry: "MRI",
      goods: "case",
    ...
    actions: {
      ...
      storagePrompt: "Discard until remaining cases fit your supply closet.",
      take: "Take",
      sell: "Bill",
      ship: "Discharge",
      onShip: "in lane",
    ...
    messages: {
      ...
      built: (playerName, buildingName) => `${playerName} opened ${buildingName}`,
      tookExtraGood: (playerName, goodName) => `${playerName} took extra ${goodName}`,
      skippedExtraGood: (playerName) => `${playerName} skipped the extra sample`,
      producedGoods: () => "processed cases",
  ...
  puerto_yugioh: themed({
    ...
    roleDescriptions: {
      ...
      trader: "Everyone may trade one card.",
      captain: "Everyone battles cards for VP.",
    ...
    roleRewards: {
      ...
      builder: "Chooser pays 1 less.",
      craftsman: "Chooser may draw 1 extra card.",
      trader: "Chooser earns +1 star.",
      captain: "Chooser earns +1 VP once.",
      prospector_1: "Chooser takes 1 star.",
      prospector_2: "Chooser takes 1 star.",
    },
    goods: { corn: "Tokens", indigo: "Spells", sugar: "Traps", tobacco: "Tributes", coffee: "Dragons" },
    plantations: {
      corn: "Tokens",
      indigo: "Spells",
      sugar: "Traps",
    ...
    buildings: {
      small_indigo_plant: "Small Spell Mill",
      small_sugar_mill: "Small Trap Forge",
      indigo_plant: "Spell Mill",
      sugar_mill: "Trap Forge",
      tobacco_storage: "Tribute Altar",
      coffee_roaster: "Dragon Roost",
      ...
      harbor: "Battle Dock",
      wharf: "Direct Attack",
      guild_hall: "Tournament Hall",
      residence: "Monster World",
      fortress: "Mirror Wall",
      customs_house: "Scorekeeper",
      city_hall: "Shadow Council",
    },
    buildingDescriptions: buildingCopy({
      indigo: "spells",
      sugar: "traps",
      tobacco: "tributes",
      coffee: "dragons",
      indigoSource: "spell zones",
      sugarSource: "trap zones",
      tobaccoSource: "tribute zones",
      coffeeSource: "dragon zones",
      money: "stars",
      settler: "field",
      quarry: "item",
      goods: "card",
      ...
      harbor: "battle",
      wharf: "direct attack",
      smallProduction: "small combo card",
      largeProduction: "large",
      island: "zone",
      shipped: "battled",
      civic: "duel",
    ...
    actions: {
      ...
      storagePrompt: "Discard until remaining cards fit your binder.",
      take: "Take",
      sell: "Trade",
      ship: "Battle",
      onShip: "in lane",
  ...
  puerto_rato: themed({
    ...
    goods: { corn: "Crumbs", indigo: "Lint", sugar: "Cheese", tobacco: "Wire", coffee: "Pizza" },
    plantations: {
      corn: "Crumbs",
      indigo: "Lint",
      sugar: "Cheese",
    ...
    buildings: {
      ...
      harbor: "Storm Drain",
      wharf: "Secret Pipe",
      guild_hall: "Guild of Whiskers",
      residence: "High-Rise Nest",
      fortress: "Tin Can Fortress",
      customs_house: "Toll Grate",
      city_hall: "Sewer Throne",
    },
    buildingDescriptions: buildingCopy({
      indigo: "lint",
      sugar: "cheese",

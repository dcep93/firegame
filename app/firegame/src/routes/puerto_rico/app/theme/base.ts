...
export const THEMES: Record<PuertoRicoThemeKey, ThemeText> = {
  ...
  puerto_rifto: themed({
    ...
    roleDescriptions: {
      settler: "Everyone claims a lane for Shurima.",
      mayor: "Everyone rallies champions to the board.",
      builder: "Everyone may invent one item.",
      craftsman: "Everyone cultivates jungle growth for roles.",
      trader: "Everyone may play one deal.",
      captain: "Everyone joins the Bilgewater barrage for VP.",
    ...
    buildings: {
      small_indigo_plant: "Sneaky",
      small_sugar_mill: "Oner",
      indigo_plant: "Doublelift",
      sugar_mill: "Trick2g",
      tobacco_storage: "Dyrus",
      coffee_roaster: "Faker",
      small_market: "Loaded Dice",
      hacienda: "Destiny",
      construction_hut: "Arise!",
      small_warehouse: "Spell Shield",
      hospice: "Auto Turret",
      office: "Wild Cards",
      large_market: "Stacked Deck",
      large_warehouse: "Unbreakable",
      factory: "Cull",
      university: "League of Draven",
      harbor: "Spirit Rush",
      wharf: "Magical Journey",
    ...
    buildingDescriptions: {
      ...
      harbor: "+1 VP each time Spirit Rush carries roles into a fight.",
      wharf: "Once per teamfight, send all roles of one kind through a Magical Journey.",
    },
    labels: {
      board: "Rift Map",
      plantations: "Lanes",
  ...
  puerto_rato: themed({
    ...
    roleDescriptions: {
      settler: "Everyone claims a hoard site or spreads disease.",
    ...
    buildingDescriptions: buildingCopy({
      ...
      tobacco: "crumbs",
      coffee: "pizza",
      indigoSource: "lint hoard sites",
      sugarSource: "cheese hoard sites",
      tobaccoSource: "crumb hoard sites",
      coffeeSource: "pizza hoard sites",
      money: "coins",
      settler: "scouting",
      quarry: "disease site",
      goods: "hoard",
    ...
    actions: {
      ...
      haciendaTile: "Loose hoard site",
      mayorHelp: "Click rat dots on your hoard sites and burrow to staff the empire.",

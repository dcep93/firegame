...
const doIfRegression = isRegression ? test.skip : test.skip;
const doIfNotRegression = !isRegression ? test : test.skip;
doIfRegression("2p.v0", multiChoreo("./choreo/2p.v0.json"));
doIfRegression("2p.v1", multiChoreo("./choreo/2p.v1.json"));
doIfNotRegression("4p.v0", multiChoreo("./choreo/4p.v0.json"));

...
export type NumericMap<T> = Record<number, T>;
...
export const getVictoryPointsToWin = (gameData: GameData) =>
...
export const parseFiniteIndex = (value: unknown) => {
  const parsed =
    typeof value === "number"
      ? value
      : typeof value === "string"
...
export const toNumericRecordEntries = <T>(
...
export const getByPlayerColor = <T>(
...
export const getWinner = (): WinnerResult | undefined => {

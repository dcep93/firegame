...
export const maps: Map[] = [
  {
    ...
    cities: [
      { color: "teal", name: "flensburg", x: 631, y: 69 },
      { color: "teal", name: "kiel", x: 708, y: 195 },
      { color: "teal", name: "cuxhaven", x: 525, y: 307 },
      { color: "teal", name: "wilhelmshaven", x: 421, y: 384 },
      { color: "teal", name: "bremen", x: 549, y: 505 },
      { color: "teal", name: "hamburg", x: 698, y: 384 },
      { color: "teal", name: "hannover", x: 701, y: 689 },
      { color: "red", name: "osnabruck", x: 433, y: 659 },
      { color: "red", name: "munster", x: 347, y: 779 },
      { color: "red", name: "dortmund", x: 372, y: 925 },
      { color: "red", name: "essen", x: 239, y: 867 },
      { color: "red", name: "duisburg", x: 143, y: 832 },
      { color: "red", name: "dusseldorf", x: 169, y: 980 },
      { color: "red", name: "kassel", x: 620, y: 960 },
      { color: "blue", name: "aachen", x: 123, y: 1121 },
      { color: "blue", name: "koln", x: 269, y: 1074 },
      { color: "blue", name: "trier", x: 186, y: 1347 },
      { color: "blue", name: "saarbrucken", x: 317, y: 1490 },
      { color: "blue", name: "mannheim", x: 516, y: 1451 },
      { color: "blue", name: "wiesbaden", x: 438, y: 1269 },
      { color: "blue", name: "frankfurt-m", x: 530, y: 1226 },
      { color: "purple", name: "freiburg", x: 385, y: 1762 },
      { color: "purple", name: "konstanz", x: 560, y: 1842 },
      { color: "purple", name: "stuttgart", x: 562, y: 1610 },
      { color: "purple", name: "augsburg", x: 810, y: 1661 },
      { color: "purple", name: "munchen", x: 961, y: 1761 },
      { color: "purple", name: "regensburg", x: 1011, y: 1540 },
      { color: "purple", name: "passau", x: 1239, y: 1643 },
      { color: "yellow", name: "nurnberg", x: 892, y: 1422 },
      { color: "yellow", name: "wurzburg", x: 721, y: 1338 },
      { color: "yellow", name: "fulda", x: 696, y: 1146 },
      { color: "yellow", name: "erfurt", x: 892, y: 1032 },
      { color: "yellow", name: "halle", x: 1003, y: 901 },
      { color: "yellow", name: "leipzig", x: 1084, y: 955 },
      { color: "yellow", name: "dresden", x: 1301, y: 1039 },
      { color: "brown", name: "frankfurt-d", x: 1360, y: 695 },
      { color: "brown", name: "berlin", x: 1202, y: 647 },
      { color: "brown", name: "magdeburg", x: 977, y: 708 },
      { color: "brown", name: "schwerin", x: 920, y: 395 },
      { color: "brown", name: "rostock", x: 1011, y: 234 },
      { color: "brown", name: "torgelow", x: 1299, y: 382 },
      { color: "brown", name: "lubeck", x: 819, y: 281 },
    ],
    edges: [
